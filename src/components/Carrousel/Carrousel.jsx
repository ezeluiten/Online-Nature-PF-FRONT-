...
const logo = ("https://res.cloudinary.com/drp8i1fbf/image/upload/v1675875853/imagesTrees/logot_qcckof.png");
        ...
        <Carousel.Caption>
          ...
          >
            <div className={style.subContaineImg}>
              ...
              <div>
                <a href="/home" className={style.myButton}>
                  GET IN!
                </a>
              </div>
            </div>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          >
            <div className={style.subContaineImg}>
              {/* <div class={style.bg}>
                <h1 class="t-stroke t-shadow-halftone">NATURE ONLINE</h1>
              </div> */}
