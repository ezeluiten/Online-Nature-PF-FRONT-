					...
					<div>
						<form onSubmit={handleSubmit}>
							<select
								...
								onChange={handleSelectForPlatforms}
							>
							...
							<input
								className={error.title && style.warning}
							...
							<input
								className={error.image && style.warning}
							...
							<input
								className={error.image_detail && style.warning}
							...
							<textarea
								className={error.description && style.warning}
							...
							<input
								className={error.amount && style.warning}
          ...
          <div>
            ...
            <h2 className={style.titleForm}>Creation form</h2>
                    ...
                    <select className={style.select} onChange={handleSelectForItems}>
                                <option value="platforms" defaultChecked>select</option>
                                {
                                    typeOfItem?.map((item, i) => (
                    ...
                    <br />
                    <label htmlFor="title">Title:</label>
                    <input className={`${error.title} && ${style.warning} ${style.inputForm}`} value={fomrInfo.title} onChange={handleInputChange} type="text" id="title" name="title" placeholder="ej: Pig"/>
                    <p className={style.danger}>{error.title}</p>
                    <br />
                    
                    <label htmlFor="image">Image</label>
                    <input className={`${error.image} && ${style.warning} ${style.inputForm}`} value={fomrInfo.image} onChange={handleInputChange} type="text" id="image" name="image" placeholder="URL"/>
                    <p className={style.danger}>{error.image}</p>
                    <br />

                    <label htmlFor="image_detail">Image detail:</label>
                    <input className={`${error.image_detail} && ${style.warning} ${style.inputForm}`} value={fomrInfo.image_detail} onChange={handleInputChange} type="text" id="image_detail" name="image_detail" placeholder="URL"/>
                    <p className={style.danger}>{error.image_detail}</p>
                    <br />
                    
                    <label htmlFor="description">Description:</label>
                    <textarea className={`${error.description} && ${style.warning} ${style.inputForm}`} value={fomrInfo.description} onChange={handleInputChange} type="text"  id="description" name="description" placeholder="Description"/>
                    <p className={style.danger}>{error.description}</p>
                    <br />

                    <label htmlFor="amount">Amount:</label>
                    <input className={`${error.amount} && ${style.warning} ${style.inputForm}`} value={fomrInfo.amount} onChange={handleInputChange} type="number" id="amount" name="amount" placeholder="ej: 30"/>
                    <p className={style.danger}>{error.amount}</p>
                    <br />
              <div className={style.buttonsForm}>
                <Button type="submit" variant="success">Create</Button>{' '}
                <Button variant="warning" onClick={handleClick}>Go back</Button>{' '}
              </div>
            </form>
          </div>
        </div>
