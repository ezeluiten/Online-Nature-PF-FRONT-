...
export const setFavorites = (item, funct) => {
  ...
  return async function (dispatch, getState) {
    ...
    if (item.selected) {
      ...
      favorites.push(item);
      console.log(
        "🚀 ~ file: index.js:35 ~ returnfunction ~ favorites",
        favorites,
        item
      );
    }
    console.log(
      "🚀 ~ file: index.js:38 ~ returnfunction ~ favorites",
      favorites,
      item
    );
    dispatch({
...
export const getUserLoggedInfoToPay = (client) => {
  return async function (dispatch, getState) {
    console.log(
      "🚀 ~ file: index.js:79 ~ getUserLoggedInfoToPay ~ client",
      client
    );
...
export const initCheckOut = () => {
  return async function (dispatch, getState) {
    ...
    axios
      .post(
        "http://localhost:3001/api/v1/checkOutController",
        {
...
export function sorting(params = "descendant", catalogue) {
  return async function (dispatch) {
    ...
    console.log(
      "🚀 ~ file: index.js:171 ~ orderedAscendantCatalogue ~ orderedAscendantCatalogue",
    ...
    console.log(
      "🚀 ~ file: index.js:182 ~ orderedDescendantCatalogue ~ orderedDescendantCatalogue",
